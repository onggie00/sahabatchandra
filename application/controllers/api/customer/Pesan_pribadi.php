...
class Pesan_pribadi extends REST_Controller {
  ...
  function index_get() {
      ...
      if(isset($headers['token']))
        ...
        if (empty($cek_token)) {
          ...
          $data = $this->mymodel->getbywhere('trans_customer',"id_trans_customer=",$id_transaksi,"row");
          ...
          if (!empty($data)) {
            ...
            $msg = array('success'=>0,'message'=>'Data tidak ditemukan');
          }
        }
